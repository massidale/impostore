...
const plugin: GamePlugin = {
  ...
  minPlayers: 4,
  maxPlayers: 0,
  rules: "Scegliete il mazzo del gioco oppure Le nostre parole: ogni partecipante può aggiungere più parole o nomi, senza duplicati. Raggiunto il numero di carte scelto, il mazzo viene mescolato. Due squadre si alternano con descrittori a rotazione. Lo stesso mazzo si gioca per tre round: descrizione libera senza dire nome o alias, una sola parola, solo mimo senza suoni. Solo il descrittore vede la carta e segna gli esiti. Le carte indovinate escono dal mazzo; passa e violazione rimettono la carta in fondo. Si può annullare l’ultima azione nel turno aperto. Il mazzo completato chiude il round.",
  SettingsPanel,
  PlayerGamepad,
  HostDashboard,
